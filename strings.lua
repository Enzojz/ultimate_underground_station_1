...
* Altitude: You can fine adjuus the altitude of the station, to make the underground entry on surface level, due to the technique limit, you can have only an max adjuusment of -/+ 6m. 
...
- Add option to adjuus common radius part length
1.8
